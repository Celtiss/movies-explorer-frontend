...
function MoviesCard({movie, handleClickMovie}) {
    ...
    return(
        <li className='card'>
            ...
            <div className='card__description'>
                ...
                {isSavedMoviesRoute && (<button type="button" onClick={handleLikeMovie} aria-label="Удалить" className={`card__btn card__delete-btn`}></button>)}
            </div>
